...
int main()
{
    ...
    porcentagemnulo=nulo/100*totalvotos;porcentagemnulo=porcentagemnulo*100;
    porcentagembranco=branco/100*totalvotos;porcentagembranco=porcentagembranco*100;
